...
namespace State.Network
{
    ...
    /// </summary>
    public static class StateNetwork
    {
        private const string RPC_SYNC_DATA = "State_SyncData";
        private const string RPC_REQUEST_SYNC = "State_RequestSync";
        ...
        public static void SyncToClient(long playerId, string moduleId)
        {
            ...
            string data = Store.SerializeModule(playerId, moduleId);
        ...
        public static void SyncAllToClient(long playerId)
        {
            ...
            foreach (string moduleId in Store.GetRegisteredModules())
            {
        ...
        private static void RPC_OnSyncData(long sender, string moduleId, string data)
        {
            ...
            Store.OnSyncReceived(moduleId, data);
        }
